        ...
        jQuery.ajax({
			...
			//alert("it has docs");
                        ...
                        for(var i=0;i<docs.length;i++){
                            if(docs[i].hasOwnProperty('Type')){
                                var link = indexDisp+"/select?q=id:%22" + docs[i].Type + "%22&wt=json&indent=true";
                                content += "<a href='" + link + "' target = '_blank'><li>" + docs[i].Type + "</li></a>";
